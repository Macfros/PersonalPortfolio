    ...
    <Container className={clsx("mt-24 sm:mt-32 lg:mt-40", centered && "text-center")}>
      <FadeIn>
        <h1 className="">
          ...
          <span className={clsx("mt-6 block max-w-5xl font-display text-5xl font medium tracking-tight text-neutral-950 [text-wrap:balace] sm:text-6xl",centered && "mx-auto")}>{title}</span>
        </h1>
